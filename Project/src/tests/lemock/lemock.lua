...
Argv = class()
Argv.ANYARGS = {} --newproxy()
local ANYARGS = Argv.ANYARGS
Argv.ANYARG  = {} -- newproxy()
local ANYARG  = Argv.ANYARG
...
function Argv:unpack ()
	return table.unpack( self.v, 1, self.len )
end
Callable = {}
...
lemock.Mock = Mock
lemock.Action = Action
lemock.Controller = Controller
lemock.Callable = Callable
lemock.controller = controller
return lemock