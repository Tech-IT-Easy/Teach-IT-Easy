return {
    ...
    ["INSTRUCTIONS_PROGRAMMING_GAME5_ROW5"] = "Navigation: By using the arrows the user can move up and down between the ",
    ["INSTRUCTIONS_PROGRAMMING_GAME5_ROW6"] = "achievements in the list.",
