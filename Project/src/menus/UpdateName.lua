...
-- @author Erik/ Marcus
-------------------------------------
function UpdateName:inactive(x1)
  if (x1 <= 10) then
...
-- @author Erik/ Marcus
-------------------------------------
function UpdateName:updatetext()
  screen:clear({ g = 255, r = 255, b = 255 }, { x = screen:get_width() * 0.1, y = screen:get_height() * 0.25 * 1.2, w = screen:get_width() * 0.8, h = screen:get_height() * 0.3 * 0.6 })
