...
trophy_room_leftarrow = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.22, y = main_menu_pagenamebaseline }, script_path .. 'data/condensed.ttf')
trophy_room_rightarrow = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.76, y = main_menu_pagenamebaseline }, script_path .. 'data/condensed.ttf')
...
settings_menu_pagename = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.07, { x = screen:get_width() * 0.39, y = main_menu_pagenamebaseline }, script_path .. 'data/Chalkduster.ttf')
...
-- @author Mikael
-------------------------------------
row_1 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.3 }, script_path .. 'data/GROBOLD.ttf')
row_2 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.35 }, script_path .. 'data/GROBOLD.ttf')
row_3 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.4 }, script_path .. 'data/GROBOLD.ttf')
row_4 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.45 }, script_path .. 'data/GROBOLD.ttf')
row_5 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.5 }, script_path .. 'data/GROBOLD.ttf')
row_6 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.55 }, script_path .. 'data/GROBOLD.ttf')
row_7 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.6 }, script_path .. 'data/GROBOLD.ttf')
row_8 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.65 }, script_path .. 'data/GROBOLD.ttf')
row_9 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.7 }, script_path .. 'data/GROBOLD.ttf')
row_10 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.75 }, script_path .. 'data/GROBOLD.ttf')
row_11 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.8 }, script_path .. 'data/GROBOLD.ttf')
row_12 = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, { x = screen:get_width() * 0.03, y = screen:get_height() * 0.85 }, script_path .. 'data/GROBOLD.ttf')

page_txt = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.06, y = screen:get_height() * 0.21 }, script_path .. 'data/GROBOLD.ttf')
page_nr = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.14, y = screen:get_height() * 0.21 }, script_path .. 'data/GROBOLD.ttf')
page_of = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.165, y = screen:get_height() * 0.21 }, script_path .. 'data/GROBOLD.ttf')
page_max = sys.new_freetype({g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.205, y = screen:get_height() * 0.21 }, script_path .. 'data/GROBOLD.ttf')
