...
trophyroom_sidebuttontext1 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.1, y = screen:get_height() * 0.45+6 }, script_path .. 'data/condensed.ttf')
trophyroom_sidebuttontext2 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.1, y = (screen:get_height() * 0.45 +  screen:get_height() * 0.1 * 1.5) + 6 }, script_path .. 'data/condensed.ttf')
trophyroom_sidebuttontext3 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.1, y =(screen:get_height() * 0.45 + 2 *  screen:get_height() * 0.1 * 1.5) + 6 }, script_path .. 'data/condensed.ttf')
