...
level_2 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
level_3 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
level_4 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
...
level_6 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
level_7 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
level_8 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
...
locked_level_2 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
locked_level_3 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
locked_level_4 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.36) }, script_path .. 'data/GROBOLD.ttf')
...
locked_level_6 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
locked_level_7 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
locked_level_8 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.13 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.73) }, script_path .. 'data/GROBOLD.ttf')
