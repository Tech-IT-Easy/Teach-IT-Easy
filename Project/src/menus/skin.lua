...
trophy_room_pagename = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.07, { x = screen:get_width() * 0.35, y = main_menu_pagenamebaseline }, script_path .. 'data/Chalkduster.ttf')
...
level_1 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.10, {  x = screen:get_width() * 0.12 + (screen:get_width() * 0.22) * (1 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
level_2 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
level_3 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
level_4 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
level_5 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (1 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
level_6 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
level_7 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
level_8 = sys.new_freetype({ g = 131, r = 0, b = 143, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
level_fonts = {level_1, level_2, level_3, level_4, level_5, level_6, level_7, level_8}


locked_level_1 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (1 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
locked_level_2 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
locked_level_3 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
locked_level_4 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.28) }, script_path .. 'data/GROBOLD.ttf')
locked_level_5 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (1 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
locked_level_6 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (2 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
locked_level_7 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (3 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
locked_level_8 = sys.new_freetype({ g = 255, r = 255, b = 255, a = 255 }, screen:get_height() * 0.04, {  x = screen:get_width() * 0.08 + (screen:get_width() * 0.22) * (4 - 1), y = (screen:get_height() * 0.65) }, script_path .. 'data/GROBOLD.ttf')
