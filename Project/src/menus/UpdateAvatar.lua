...
-- @author Erik; Marcus
-------------------------------------
function UpdateAvatar:loadview(input)
  self.pos = 1
  self.lastpos = 1
  self.username = input
...
-- @author Erik
-------------------------------------
function UpdateAvatar:active(x1)
...
-- @author Erik
-------------------------------------
function UpdateAvatar:inactive(x1)
...
-- @author Erik; Marcus
-------------------------------------
function UpdateAvatar:renderui()
