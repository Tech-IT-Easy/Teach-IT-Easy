...
function UICatchMainWindow:initialize(args)
  ...
  for i =1,len do
    self.words[i] = UIRectangleView:new{frame={x=100*i+20,y=20,w=80,h=80},borderColor=THEME.COLOR.LIGHT_BLUE,borderWidth = 4}
    bottomPanel:addChildView(self.words[i])
  end
  self:addChildView(bottomPanel)
end
