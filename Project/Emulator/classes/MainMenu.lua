...
function MainMenu:new()
  ...
  self.games = sys.new_freetype({g=131, r=0, b=143}, screen:get_height()*0.1, {x= screen:get_width()*0.165, y=(screen:get_height()*0.75)}, script_path..'data/BlackoutMidnight.ttf')
