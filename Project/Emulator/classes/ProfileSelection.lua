...
function ProfileSelection:new()
    ...
    -- fonts
     ...
     self.addprofilename = sys.new_freetype({ g = 131, r = 0, b = 143 }, screen:get_height() * 0.03, { x = screen:get_width() * 0.38, y = screen:get_height() * 0.88 }, script_path .. 'data/GROBOLD.ttf')
