...
function ProfileSelection:new()
    ...
    -- fonts
     ...
     self.addprofilename = sys.new_freetype({ g = 255, r = 255, b = 255 }, screen:get_height() * 0.05, { x = screen:get_width() * 0.38, y = screen:get_height() * 0.88 }, script_path .. 'data/Chalkduster.ttf')
